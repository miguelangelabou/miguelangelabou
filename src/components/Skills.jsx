...
import { Database, Layout, Server, Settings, Code2, Globe, Cpu, Layers, Cloud, Terminal, Shield, Workflow, FileText, Binary, Zap, Network } from 'lucide-react';
          ...
          <div className="glass-panel p-6 rounded-2xl h-fit hover:border-green-500/30 transition-colors">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                    <SkillPill name="WebSockets" icon={<Network size={14} />} color="text-white dark:text-gray-200" />
